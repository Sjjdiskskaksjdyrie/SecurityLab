...
invkeymat[2][0]; y = posa * invkeymat[0][1] + posb * invkeymat[1][1] + posc
* invkeymat[2][1]; z = posa * invkeymat[0][2] + posb * invkeymat[1][2] + posc
...
msg); char[] pdchars = msg.toCharArray(); for
(int i = 0; i < msg.length(); i += 3) {
